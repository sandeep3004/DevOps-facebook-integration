...
import static com.hp.fb.integration.Constants.*;
...
public class MainMenu extends HttpServlet 
{
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res)throws ServletException, IOException 
		...
		Facebook1 Client=new Facebook1(); 
   		...
   		String acc="https://graph.facebook.com/v2.2/oauth/access_token?grant_type=fb_exchange_token&client_id=1017716151612815&client_secret=2cd4ceb1e5fef5c3dabd1eaf601cb9e0&fb_exchange_token="+code;
   		System.out.println(" XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX" +acc);
   		
   		AccessToken accessToken4 =
   			  new DefaultFacebookClient().obtainAppAccessToken(FB_APP_ID,
   			    FB_APP_SECRET);
